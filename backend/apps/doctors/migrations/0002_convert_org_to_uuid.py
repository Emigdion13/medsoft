...
class Migration(migrations.Migration):
    """Convert doctor organization_id from bigint to UUID."""
    ...
    operations = [
        ...
        migrations.RunSQL(
            sql="""
                ...
                DROP CONSTRAINT IF EXISTS doctors_doctor_organization_id_8d9a4b2f_fk_core_orga;
            """,
        ...
        migrations.RunSQL(
            sql="""
                ALTER TABLE doctors_doctor 
                ADD CONSTRAINT doctors_doctor_organization_id_8d9a4b2f_fk_core_orga 
                FOREIGN KEY (organization_id) REFERENCES core_organizations_organization(id);
            """,
            reverse_sql="ALTER TABLE doctors_doctor DROP CONSTRAINT IF EXISTS doctors_doctor_organization_id_8d9a4b2f_fk_core_orga;",
        ),
    ]
